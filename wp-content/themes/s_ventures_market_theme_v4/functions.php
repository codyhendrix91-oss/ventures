    ...
    if (empty($logo)) {
        ...
        foreach ($possible_names as $base_name) {
            ...
            if (file_exists($webp_path)) {
                $logo = $theme_url . '/assets/' . $base_name . '.webp';
                $fallback_logo = $theme_url . '/assets/' . $base_name . '.png';
                $found_logo = true;
                break;
            }
            // Try png
            ...
            if (file_exists($png_path)) {
                $logo = $theme_url . '/assets/' . $base_name . '.png';
                $found_logo = true;
                break;
            }
        }
            ...
            if (is_dir($assets_dir)) {
                ...
                foreach ($files as $file) {
                    ...
                    if (strtolower(pathinfo($filename, PATHINFO_FILENAME)) === $search_pattern) {
                        ...
                        // Set fallback to opposite extension
                        $ext = pathinfo($filename, PATHINFO_EXTENSION);
                        $fallback_ext = ($ext === 'webp') ? 'png' : 'webp';
                        $fallback_name = pathinfo($filename, PATHINFO_FILENAME) . '.' . $fallback_ext;
                        if (file_exists($assets_dir . $fallback_name)) {
                            $fallback_logo = $theme_url . '/assets/' . $fallback_name;
                        }
                        break;
                    }
                }
