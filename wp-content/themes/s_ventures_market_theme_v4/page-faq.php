...
.faq-highlight {
  background: linear-gradient(135deg, rgba(0, 217, 255, 0.2) 0%, rgba(46, 252, 134, 0.2) 100%);
  padding: 2px 4px;
  border-radius: 4px;
  font-weight: 600;
}
  ...
  <div class="faq-page__content">
    ...
    <div class="faq-contact">
      ...
      <div class="faq-contact__buttons">
        ...
        <a href="https://wa.me/12817261751" class="faq-contact__btn faq-contact__btn--secondary" target="_blank">
        ...
        <a href="https://t.me/s_ventures" class="faq-contact__btn faq-contact__btn--secondary" target="_blank">
          <svg viewBox="0 0 24 24" fill="currentColor">
